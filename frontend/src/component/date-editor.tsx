...
export type DateEditorClasses = Classes<"events" | "formGroup" | "formContent">;
  ...
  return (
    <div style={{ position: "relative", width: "100%" }}>
      <div
        style={{
          display: "flex",
          flexDirection: displaySize === "pc" ? "row" : "column",
        }}
      >
        <div
          style={{
            ...
            flexGrow: "1",
            display: "flex",
            alignSelf: displaySize === "pc" ? "center" : "flex-start",
          }}
        >
          <div style={{ width: displaySize === "pc" ? "20px" : "10px" }}></div>
        ...
        <div
          style={{
            ...
            alignSelf: displaySize === "pc" ? "center" : "flex-end",
          }}
        >
          <FormControlLabel
            sx={{ my: 1 }}
      ...
      <div className={classes.formContent}>
        <div
          ...
          style={{ margin: displaySize === "pc" ? "12px 0" : 0 }}
        >
              ...
              onChange={(e) => {
                setDateEvents((current) => {
                  ...
                  const updateTarget = current[
                    currentDateEventIndex
                  ].events.find((event) => event.type === "drinking") as
                    | DrinkEvent
                    | undefined;
                  return updateEvent(current, currentDateEventIndex, [
                    {
            ...
            <TextField
              ...
              onChange={(e) => {
                setDateEvents((current) => {
                  ...
                  const updateTarget = current[
                    currentDateEventIndex
                  ].events.find((event) => event.type === "drinking");
                  return updateEvent(current, currentDateEventIndex, [
                    {
                      type: "drinking",
